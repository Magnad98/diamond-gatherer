...
socket.on("menu", () => {
    document.getElementById("menu-container").classList.remove("display-none");
...
socket.on("joined-chat", () => {
    ...
    document.getElementById("menu-container").classList.add("display-none");

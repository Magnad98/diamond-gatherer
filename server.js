...
const createEmployees = () => {
    ...
    leonard.present().work().getSalary().getSalaryRiseTo(2800).getSalary().getVacantion(38);
    penny.present().work().getSalary().getSalaryRiseTo(1200).getSalary().getVacantion(6);
};
